...
export function DropdownItem(props: DropdownItemProps & { children?: any }) {
  return (
    <div class="border-none border-solid border-gray-300 last:border-b-0 ">
      <div class="w-full bg-gray-100 text-base sm:text-lg font-semibold text-left cursor-pointer hover:bg-gray-200 min-h-[44px] flex items-center" onClick={() => props.toggle(props.id)}>
